...
export function AdminTable<T>({
  ...
  emptyDescription = '새로운 항목을 추가해보세요'
}: TableProps<T>) {
        ...
        <div className={styles.infoCard}>
          <div className={styles.infoContent}>
            <div>
              ...
              <p className={styles.tableStats}>
                총 <span className={styles.highlight}>{totalCount.toLocaleString()}</span>개
                {totalCount > 0 && (
                ...
                <tr>
                  ...
                  >
                    <div className={styles.noDataContent}>
                      ...
                      <p className={styles.noDataText}>{emptyDescription}</p>
                    </div>
                  </td>
                </tr>
              )}
